...
/**
 * class that handles createPortfolio command.
 */
public class CreatePortfolio implements PortfolioSimulatorCommand {
  ...
  public void executeCommand(DollarCostAverage pModel, PortfolioView pView, Scanner input) {
    ...
    addAndSaveStocksToPortfolio(pModel, pView, input, null);
